...
const char* deviceID = "ESP32_5"; 

const char* distanceTopic = "ultrasonic_distance_5";  // MQTT topic for distance data
const char* motionTopic = "Esp32_5_triggered";        // MQTT topic for motion detection
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    if (distanceCm < MAX_DISTANCE) {
      if (!beamBroken) {
        ...
        if (client.publish(motionTopic, "G3")) {
          Serial.println("note_5_detected, Message sent.");
          beamBroken = true;
        } else {
